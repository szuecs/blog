...
but had no routes created by [Kubernetes Ingress](https://kubernetes.io/docs/concepts/services-networking/ingress/)
and [RouteGroup](https://opensource.zalando.com/skipper/kubernetes/routegroup-crd/)
...
control loop got the connection to the [skipper-ingress](https://opensource.zalando.com/skipper/kubernetes/ingress-controller/) that responded
...
`<some-path>/foo.php`. And yes, in this case they want to have a 5xx
status code.
